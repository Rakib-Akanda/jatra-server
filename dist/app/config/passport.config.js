...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    clientID: env_1.envVars.GOOGLE_OAUTH.GOOGLE_CLIENT_ID,
    clientSecret: env_1.envVars.GOOGLE_OAUTH.GOOGLE_CLIENT_SECRET,
    callbackURL: env_1.envVars.GOOGLE_OAUTH.GOOGLE_CALLBACK_URL,
